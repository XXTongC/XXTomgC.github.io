...
date: 2023-11-17
categories: [算法, 算法技巧]
tags: [双指针, two-pointers, 快慢指针, 对撞指针, 滑动窗口, 算法优化, 数组, 链表]
---
# 双指针算法
...
![题一-1](/algorithm/two-pointers/pic/Question1-1.png)   
![题二-2](/algorithm/two-pointers/pic/Question1-2.png)
...
![题二](/algorithm/two-pointers/pic/Question2.png)
...
![2-1](/algorithm/two-pointers/pic/2-1.png)

开始遍历：

![2-2](/algorithm/two-pointers/pic/2-2.png)

出现重复元素，更新最大长度，i 指针向后遍历**直至消去重复元素**：

![2-3](/algorithm/two-pointers/pic/2-3.png)

继续向后遍历，以此循环：

![2-4](/algorithm/two-pointers/pic/2-4.png)
