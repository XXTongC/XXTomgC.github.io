...
date: 2024-10-30
categories: [算法, 数据结构]
tags: [数据结构, 线段树, segment-tree, 区间查询, 区间修改, 树状数组, RMQ]
---
# 线段树
...
![0-1](/algorithm/data-structures/segment-tree/pic/0-1.png)
...
![题一-1](/algorithm/data-structures/segment-tree/pic/Question1-1.png)
![题一-2](/algorithm/data-structures/segment-tree/pic/Question1-2.png)
![题一-3](/algorithm/data-structures/segment-tree/pic/Question1-3.png)
...
![Question2-1](/algorithm/data-structures/segment-tree/pic/Question2-1.png)
![Question2-1](/algorithm/data-structures/segment-tree/pic/Question2-2.png)
...
![2-1](/algorithm/data-structures/segment-tree/pic/2-1.png)
...
![2-2](/algorithm/data-structures/segment-tree/pic/2-2.png)
![2-3](/algorithm/data-structures/segment-tree/pic/2-3.png)

对于前两种可能，我们只需要记录每个区间的最值就能更新，所以这里我们需要储存一个$tmax$ 来代表这个区间的最大连续子段和

![2-4](/algorithm/data-structures/segment-tree/pic/2-4.png)
...
![2-5](/algorithm/data-structures/segment-tree/pic/2-5.png)
...
![Question3-1](/algorithm/data-structures/segment-tree/pic/Question3-1.png)
![Question3-2](/algorithm/data-structures/segment-tree/pic/Question3-2.png)
...
![4-1](/algorithm/data-structures/segment-tree/pic/4-1.png)

当我们的查询区间包括了被标记区间，那么标记不会下沉，因为根据我们的查询，我们遇到区间被包含时是之间返回该节点对应信息。

![4-3](/algorithm/data-structures/segment-tree/pic/4-3.png)

但当查询区间为如图时，懒标记会被下沉（记得下沉过后删除父节点的标记），此时我们的线段树又被更新了一次。

![4-2](/algorithm/data-structures/segment-tree/pic/4-2.png)

## 题四

![Question4-1](/algorithm/data-structures/segment-tree/pic/Question4-1.png)
![Question4-2](/algorithm/data-structures/segment-tree/pic/Question4-2.png)
...
![Question5-1](/algorithm/data-structures/segment-tree/pic/Question5-1.png)
![Question5-2](/algorithm/data-structures/segment-tree/pic/Question5-2.png)
![Question5-3](/algorithm/data-structures/segment-tree/pic/Question5-3.png)
![Question5-4](/algorithm/data-structures/segment-tree/pic/Question5-4.png)
...
![5-3](/algorithm/data-structures/segment-tree/pic/5-3.png)
...
![Question6-1](/algorithm/data-structures/segment-tree/pic/Question6-1.png)
![Question6-2](/algorithm/data-structures/segment-tree/pic/Question6-2.png)
...
![Question7-1](/algorithm/data-structures/segment-tree/pic/Question7-1.png)
...
![Question](/algorithm/data-structures/segment-tree/pic/Question8.png)
