...
date: 2029-09-16
categories: [算法, 数学]
tags: [数论, 约数, divisors, 因数, 试除法, 约数个数, 约数之和, 最大公约数, 最小公倍数]
---
# 约数

## 题一

![题一](/algorithm/number-theory/divisors/pic/Question1.png)
...
![题二](/algorithm/number-theory/divisors/pic/Question2.png)

此题需要补充一些数学知识：     

![数学知识补充](/algorithm/number-theory/divisors/pic/Supplementary%20knowledge.png)
...
![题三](/algorithm/number-theory/divisors/pic/Question3.png)
...
![题四](/algorithm/number-theory/divisors/pic/Question4.png)
