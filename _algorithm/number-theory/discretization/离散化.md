...
date: 2023-08-12
categories: [算法, 数据处理]
tags: [离散化, discretization, 坐标压缩, 数据压缩, 映射, 排序, 去重]
---
# 离散化

一般运用于将离散的区间整合到一个有序的区间中。我们直接看题目

![图一题目](/algorithm/number-theory/discretization/pic/pic1.png)
...
***
贴图！
![图二](/algorithm/number-theory/discretization/pic/pic2.jpg)
为了避免看不懂我的字，手打一遍：
