...
date: 2023-09-20
categories: [算法, 数学]
tags: [数论, 中国剩余定理, CRT, 线性同余方程组, 孙子定理, 扩展中国剩余定理, 模运算]
---
# 中国剩余定理
...
![关于x的线性方程组](/algorithm/number-theory/chinese-remainder-theorem/pic/TheGrups.png)
...
![题一](/algorithm/number-theory/chinese-remainder-theorem/pic/Question1.png)
