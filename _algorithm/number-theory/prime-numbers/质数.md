...
date: 2024-08-08
categories: [算法, 数学]
tags: [数论, 质数, prime, 素数, 试除法, 埃氏筛, 线性筛, 欧拉筛, 质因数分解]
---
# 质数
...
![题一](/algorithm/number-theory/prime-numbers/pic/Question1.png)
...
![题二](/algorithm/number-theory/prime-numbers/pic/Question2.png)
