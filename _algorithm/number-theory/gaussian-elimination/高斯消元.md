---
title: "高斯消元（Gaussian Elimination）"
date: 2023-11-03
categories: [算法, 数学]
tags: [线性代数, 高斯消元, gaussian-elimination, 线性方程组, 矩阵, 数学算法, 消元法]
math: true
---
# 高斯消元
...
![题一](/algorithm/number-theory/gaussian-elimination/pic/Question1.png)
将例题的系数抽象为矩阵：
...
## 题二
![题二](/algorithm/number-theory/gaussian-elimination/pic/Question2.png)
异或运算也被称为不进位的加法
