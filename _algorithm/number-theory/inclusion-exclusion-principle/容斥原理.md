...
date: 2023-09-24
categories: [算法, 数学]
tags: [容斥原理, inclusion-exclusion, 组合数学, 集合论, 计数原理, 状态压缩, 位运算]
---
# 容斥原理

## 题一

![题一](/algorithm/number-theory/inclusion-exclusion-principle/pic/Question1.png)

容斥原理总结下来一个公式：

![容斥原理](/algorithm/number-theory/inclusion-exclusion-principle/pic/1-1.jpg)
