---
title: "求组合数（Combinatorial Number / Binomial Coefficient）"
date: 2023-08-11
categories: [算法, 数学]
tags: [组合数, 组合数学, 二项式系数, 杨辉三角, 帕斯卡三角, 逆元, 卢卡斯定理, lucas]
---
# 求组合数
...
![题一](/algorithm/number-theory/combinatorial-number/pic/Quesiton1.png)
...
***
![题二](/algorithm/number-theory/combinatorial-number/pic/Quesiton2.png)
...
![题三](/algorithm/number-theory/combinatorial-number/pic/Quesiton3.png)
...
手写证明：
![手写证明](/algorithm/number-theory/combinatorial-number/pic/writeByHand.jpg)
...
![题四](/algorithm/number-theory/combinatorial-number/pic/Quesiton4.png)
...
![题五](/algorithm/number-theory/combinatorial-number/pic/Quesiton5.png)

此题我们将问题转换：求有几条到达点(n, n)路径使得在路途的任意一点右转数量（用0表示）大于向上走（用1表示）

![5-1](/algorithm/number-theory/combinatorial-number/pic/5-1.png)
...
![5-2](/algorithm/number-theory/combinatorial-number/pic/5-2.png)
