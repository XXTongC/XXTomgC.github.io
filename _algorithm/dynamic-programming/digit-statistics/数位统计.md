---
title: "数位统计（Digit Statistics）"
date: 2023-11-23
categories: [算法, 动态规划]
tags: [dp, 动态规划, 数位统计, 数位dp, digit-dp, 数学]
---
# 数位统计

## 题一

![题一](/algorithm/dynamic-programming/digit-statistics/pic/Question1.png)
...
集合图解
![1-1](/algorithm/dynamic-programming/digit-statistics/pic/1-1.png)
