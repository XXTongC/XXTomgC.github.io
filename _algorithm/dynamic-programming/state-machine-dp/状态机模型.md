---
title: "状态机模型（State Machine Model）"
date: 2023-11-25
categories: [算法, 动态规划]
tags: [dp, 动态规划, 状态机, state-machine, 状态转移]
---
# 状态机模型
...
![0-1](/algorithm/dynamic-programming/state-machine-dp/pic/0-1.png)
...
![题一-1](/algorithm/dynamic-programming/state-machine-dp/pic/Question1-1.png)   
![题二-2](/algorithm/dynamic-programming/state-machine-dp/pic/Question1-2.png)
...
![1-1](/algorithm/dynamic-programming/state-machine-dp/pic/1-1.png)
...
![题二-1](/algorithm/dynamic-programming/state-machine-dp/pic/Question2-1.png)   
![题二-2](/algorithm/dynamic-programming/state-machine-dp/pic/Question2-2.png)

***

根据此题，分析出状态机如下：

![2-1](/algorithm/dynamic-programming/state-machine-dp/pic/2-1.png)
...
![题三-1](/algorithm/dynamic-programming/state-machine-dp/pic/Question3-1.png)   
![题三-2](/algorithm/dynamic-programming/state-machine-dp/pic/Question3-2.png)

如果将彩票模型Ⅳ做懂以后此题其实十分简单，因为此题一个是少了买卖次数的限制，让我们少了一维，二是此题只不过多了一个冷冻空仓期的状态。

根据此题，分析出状态机如下：

![3-1](/algorithm/dynamic-programming/state-machine-dp/pic/3-1.png)
...
![题四-1](/algorithm/dynamic-programming/state-machine-dp/pic/Question4-1.png)   
![题四-2](/algorithm/dynamic-programming/state-machine-dp/pic/Question4-2.png)
...
状态演示   
![4-1](/algorithm/dynamic-programming/state-machine-dp/pic/4-1.png)
...
![题五-1](/algorithm/dynamic-programming/state-machine-dp/pic/Question5-1.png)
![题五-2](/algorithm/dynamic-programming/state-machine-dp/pic/Question5-2.png)
![题五-2](/algorithm/dynamic-programming/state-machine-dp/pic/Question5-3.png)
