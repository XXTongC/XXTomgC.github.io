---
title: "数字三角形模型（Digital Triangle Model）"
date: 2023-10-21
categories: [算法, 动态规划]
tags: [dp, 动态规划, 数字三角形, 路径问题, 经典模型]
---
# 数字三角形模型

## 题一

![题一](/algorithm/dynamic-programming/digital-triangle/pic/Question1.png)   
![题一-1](/algorithm/dynamic-programming/digital-triangle/pic/Question1-1.png)
...
![1-1](/algorithm/dynamic-programming/digital-triangle/pic/1-1.png)    
![1-2](/algorithm/dynamic-programming/digital-triangle/pic/1-2.png)
***
...
![图解](/algorithm/dynamic-programming/digital-triangle/pic/1-1.png)
...
![题二](/algorithm/dynamic-programming/digital-triangle/pic/Question2-1.png)    
![题二](/algorithm/dynamic-programming/digital-triangle/pic/Question2-2.png)
...
![题三-1](/algorithm/dynamic-programming/digital-triangle/pic/Question3-1.png)    
![题三-2](/algorithm/dynamic-programming/digital-triangle/pic/Question3-2.png)
...
![3-1](/algorithm/dynamic-programming/digital-triangle/pic/3-1.png)

根据图解，我们首先能把到达$map[k, i_1,i_2]$的状态不重不漏地分成以上四种

![3-2](/algorithm/dynamic-programming/digital-triangle/pic/3-2.png)    
![3-6](/algorithm/dynamic-programming/digital-triangle/pic/3-6.png)
...
![3-3](/algorithm/dynamic-programming/digital-triangle/pic/3-3.png)    
![3-4](/algorithm/dynamic-programming/digital-triangle/pic/3-4.png)    
![3-5](/algorithm/dynamic-programming/digital-triangle/pic/3-5.png)    
...
![题四-1](/algorithm/dynamic-programming/digital-triangle/pic/Question4-1.png)   
![题四-2](/algorithm/dynamic-programming/digital-triangle/pic/Question4-2.png)
