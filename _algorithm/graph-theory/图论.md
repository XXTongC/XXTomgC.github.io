...
![题一](/algorithm/DFS/pic/Question1.png)

此题没有什么巧妙的算法，我们只能用暴力方法一一列举，但你的计算机并不会，你需要告诉计算机怎么去一一列举。

我们以n = 3 画个图举个例：

![DFS-1](/algorithm/graph-theory/pic/DFS-1.png)

那么DFS实际上的搜索路线如下：

![DFS-2](/algorithm/graph-theory/pic/DFS-2.png)
...
![题二](/algorithm/DFS/pic/Question2.png)
...
![QBFS-1](/algorithm/graph-theory/pic/QBFS-1.png)
![QBFS-2](/algorithm/graph-theory/pic/QBFS-2.png)
...
![BFS](/algorithm/graph-theory/pic/BFS-1.png)
...
![QBFS-3](/algorithm/graph-theory/pic/QBFS-3.png)
![QBFS-4](/algorithm/graph-theory/pic/QBFS-4.png)
...
![QMAPDFS-1](/algorithm/graph-theory/pic/QMAPDFS-1.png)
![QMAPDFS-2](/algorithm/graph-theory/pic/QMAPDFS-2.png)
...
![QBFS-1](/algorithm/graph-theory/pic/QMAPDFS-3.png)
...
![MAPBFS-1](/algorithm/graph-theory/pic/MAPBFS-1.png)

此时此图可构成的其中一个括扑序列：1 2 3 4 5

![MAPBFS-2](/algorithm/graph-theory/pic/MAPBFS-2.png)

此时此图可构成的其中一个括扑序列：6 1 2 3 4 5

![MAPBFS-3](/algorithm/graph-theory/pic/MAPBFS-3.png)

此时此图可构成的其中一个括扑序列：1 2 4 3 5

![MAPBFS-4](/algorithm/graph-theory/pic/MAPBFS-4.png)
...
![MAPBFS-5](/algorithm/graph-theory/pic/MAPBFS-5.png)

二、将队列中的节点取出，让后遍历其子节点并删除其连向子节点的边，即使子节点入度-1。如果此时子节点入度为0，将其推入队列中。

![MAPBFS-6](/algorithm/graph-theory/pic/MAPBFS-6.png)
![MAPBFS-7](/algorithm/graph-theory/pic/MAPBFS-7.png)
...
![一个简单图](/algorithm/graph-theory/pic/SimpleMap.png)
...
![一个简单二分图](/algorithm/graph-theory/pic/Simple%20Bipartite%20Graph.png)

二分图的实际意义：

匹配程序员和岗位

![二分图的实际应用](/algorithm/graph-theory/pic/RealityMeaningOfBipartiteGraph.png)
...
![最短路问题的几个解决方法](/algorithm/graph-theory/pic/SolutionOfShortestPath.png)

因为无向图是一种特殊的有向图，所以我们在处理无向图的最短路问题的时候通常沿用有向图的最短路问题解法。

![最短路问题](/algorithm/graph-theory/pic/ShortestPathQuestion.png)
...
![题设](/algorithm/graph-theory/pic/Single-Sourse%20Shortest%20Path%20Proplem.png)

题目的意思是从给出的图中，以s为起点，找出到其他所有节点的最短路径

![最短路表](/algorithm/graph-theory/pic/ShortestPathMatchingMap.png)
