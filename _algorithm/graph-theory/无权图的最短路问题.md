---
title: "无权图的最短路问题（Unweighted Shortest Path）"
date: 2023-09-10
categories: [算法, 图论]
tags: [图论, 最短路, bfs, 广度优先搜索, 无权图, shortest-path]
---
# 无权图的最短路问题

时间复杂度O(n) = n+m

![题设](/algorithm/graph-theory/pic/InitialState.png)
...
![queue-1](/algorithm/graph-theory/pic/InitialState-queue1.png)
1. 此时我们开始第二步——    
...
![伪代码流程图](/algorithm/graph-theory/pic/InitialState-show.png)    
