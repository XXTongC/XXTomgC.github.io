---
title: "染色法判断二分图（Bipartite Graph Coloring）"
date: 2023-09-13
categories: [算法, 图论]
tags: [图论, 二分图, bipartite-graph, 染色法, dfs, bfs, 图着色]
---
# 染色法判断二分图

时间复杂度 O(n+m)

![题一](/algorithm/graph-theory/bipartite-graph-coloring/pic/Question1.png)
