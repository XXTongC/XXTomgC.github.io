---
title: "有权图的最短路问题（Weighted Shortest Path）"
date: 2023-09-10
categories: [算法, 图论]
tags: [图论, 最短路, dijkstra, bellman-ford, spfa, floyd, 有权图, shortest-path]
---
# 有权图的最短路问题
## 单元最短路问题 —— 给定起点和终点
![单元最短路问题](/algorithm/graph-theory/pic/Single-Source%20Shortest%20Path%20in%20Weighted%20Graph.png)

这里介绍Dijkstra's Algorithm      
## Dijkstra's Algorithm
***
![需要用到的工具](/algorithm/graph-theory/pic/toolsWeNeed.png)
...
![Dijkstra算法思路](/algorithm/graph-theory/pic/Dijkstra.png)
