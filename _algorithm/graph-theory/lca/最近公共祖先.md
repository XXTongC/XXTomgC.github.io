---
title: "最近公共祖先（Lowest Common Ancestor - LCA）"
date: 2024-08-20
categories: [算法, 图论, 树]
tags: [图论, 树, lca, 最近公共祖先, 倍增, tarjan, 树上问题]
---
# 最近公共祖先LCA

最近公共祖先也称LCA常常用于与树相关的问题，例如有一棵树如下图：

![0-1](/algorithm/graph-theory/lca/pic/0-1.png)
...
![Question1](/algorithm/graph-theory/lca/pic/Question1.png)
...
![2-1](/algorithm/graph-theory/lca/pic/2-1.png)

在实际操作时，在DFS回退时会将已经遍历过的节点通过并查集合并到其父节点上，这个操作被称为缩点操作。

![2-2](/algorithm/graph-theory/lca/pic/2-2.png)
...
![Question2](/algorithm/graph-theory/lca/pic/Question2.png)
...
![Question4-1](/algorithm/graph-theory/lca/pic/Question4-1.png)
![Question4-2](/algorithm/graph-theory/lca/pic/Question4-2.png)
...
![4-1](/algorithm/graph-theory/lca/pic/4-1.png)
