...
tags: [哈夫曼树, huffman, 最优二叉树, 贪心算法, 编码, 数据压缩, 优先队列]
---
# 哈夫曼树

## 题一

![题一-1](/algorithm/greedy-algorithm/huffman-tree/pic/Question1-1.png)
![题一-2](/algorithm/greedy-algorithm/huffman-tree/pic/Question1-2.png)
