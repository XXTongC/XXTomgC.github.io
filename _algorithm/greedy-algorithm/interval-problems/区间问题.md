---
title: "区间问题（Interval Problems）"
date: 2023-10-13
categories: [算法, 贪心]
tags: [区间问题, 贪心算法, 区间调度, 区间覆盖, 区间合并, interval-scheduling]
---
# 区间问题
...
![题一](/algorithm/greedy-algorithm/interval-problems/pic/Question1.png)
...
![1-1](/algorithm/greedy-algorithm/interval-problems/pic/1-1.png)
...
![题二](/algorithm/greedy-algorithm/interval-problems/pic/Question2.png)
...
![题三](/algorithm/greedy-algorithm/interval-problems/pic/Question3.png)
...
![题四](/algorithm/greedy-algorithm/interval-problems/pic/Question4-1.png)

曾经在POJ做过类似题目（其实可以说是一模一样了），现将其题目也贴出让大家参考一下。

![题四POJ_2376](/algorithm/greedy-algorithm/interval-problems/pic/Question4-2.png)
...
![4-1](/algorithm/greedy-algorithm/interval-problems/pic/4-1.png)
