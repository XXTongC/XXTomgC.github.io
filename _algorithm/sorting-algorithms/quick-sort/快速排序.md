...
date: 2023-10-16
categories: [算法, 排序算法]
tags: [排序, quick-sort, 快速排序, 分治算法, 双指针, partition]
---
# 快速排序
...
![快排模拟](/algorithm/sorting-algorithms/quick-sort/pic/1-1.png)

在朴素的版本中，我们需要遍历这个数组然后将元素转移到新的数组以后再赋值回到我们的原始数组，这相对于多进行了一轮操作：
![1-2](/algorithm/sorting-algorithms/quick-sort/pic/1-2.png)
...
![1-3](/algorithm/sorting-algorithms/quick-sort/pic/1-3.png)   
![1-4](/algorithm/sorting-algorithms/quick-sort/pic/1-4.png)    
![1-5](/algorithm/sorting-algorithms/quick-sort/pic/1-5.png)
...
![题一](/algorithm/sorting-algorithms/quick-sort/pic/Question1.png)
...
![题二](/algorithm/sorting-algorithms/quick-sort/pic/Question2.png)
