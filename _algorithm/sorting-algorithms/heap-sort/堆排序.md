...
date: 2023-09-07
categories: [算法, 排序算法]
tags: [排序, heap-sort, 堆排序, 堆, 优先队列, 二叉堆]
---
# 堆排序
堆的基本作用：    
1. 维护一个数据集合    
...
![题一](/algorithm/sorting-algorithms/heap-sort/pic/Question1.png)
...
![题二](/algorithm/sorting-algorithms/heap-sort/pic/Question2.png)
